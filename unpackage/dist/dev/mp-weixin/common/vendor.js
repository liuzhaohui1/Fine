...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"乐舍陶艺","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!***********************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/static/index.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.courseOrder = exports.classOrder = exports.shopOrder = exports.shopList = exports.upload = exports.goodWorks = exports.submitComment = exports.video = exports.cancel = exports.order = exports.myVip = exports.autoym = exports.message = exports.gong = exports.good = exports.comment = exports.workShow = exports.workList = exports.login = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/static/request.js */ 13));
var _base = _interopRequireDefault(__webpack_require__(/*! @/static/base.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 登录
var login = function login(data) {return _request.default.post('/user/wechatLogin', _base.default.encode(JSON.stringify(data)));};

// 作品展示
exports.login = login;var workList = function workList(data) {return _request.default.post('/api/works/worksList', _base.default.encode(JSON.stringify(data)));};

// 作品详情
exports.workList = workList;var workShow = function workShow(data) {return _request.default.post('/api/works/worksDetails', _base.default.encode(JSON.stringify(data)));};

// 评论列表
exports.workShow = workShow;var comment = function comment(data) {return _request.default.post('/api/works/commentList', _base.default.encode(JSON.stringify(data)));};

// 点赞列表
exports.comment = comment;var good = function good(data) {return _request.default.post('/api/works/likeList', _base.default.encode(JSON.stringify(data)));};

//公共参数
exports.good = good;var gong = function gong() {return _request.default.post('/api/user/config');};

//我的信息
exports.gong = gong;var message = function message(data) {return _request.default.post('/api/user/mine', _base.default.encode(JSON.stringify(data)));};

//会员实名认证
exports.message = message;var autoym = function autoym(data) {return _request.default.post('/api/user/certified', _base.default.encode(JSON.stringify(data)));};

//会员实名认证
exports.autoym = autoym;var myVip = function myVip(data) {return _request.default.post('/api/user/memberLog', _base.default.encode(JSON.stringify(data)));};

//我的订单列表
exports.myVip = myVip;var order = function order(data) {return _request.default.post('/api/user/orderList', _base.default.encode(JSON.stringify(data)));};

// 取消订单
exports.order = order;var cancel = function cancel(data) {return _request.default.post('/api/user/orderCancel', _base.default.encode(JSON.stringify(data)));};

// 课程视频
exports.cancel = cancel;var video = function video(data) {return _request.default.post('/api/video/videoList', _base.default.encode(JSON.stringify(data)));};

// 提交评论
exports.video = video;var submitComment = function submitComment(data) {return _request.default.post('/api/works/sendComment', _base.default.encode(JSON.stringify(data)));};

// 点赞作品
exports.submitComment = submitComment;var goodWorks = function goodWorks(data) {return _request.default.post('/api/works/sendLike', _base.default.encode(JSON.stringify(data)));};

// 发布作品
exports.goodWorks = goodWorks;var upload = function upload(data) {return _request.default.post('/api/works/sendWorks', _base.default.encode(JSON.stringify(data)));};

// 上传图片
// export const uploadPic = (data)=>http.post('/api/common/upload',Base64.encode(JSON.stringify(data)))

// 门店列表
exports.upload = upload;var shopList = function shopList(data) {return _request.default.post('/api/index/shopList', _base.default.encode(JSON.stringify(data)));};

// 门店详情
exports.shopList = shopList;var shopOrder = function shopOrder(data) {return _request.default.post('/api/index/shopDetails', _base.default.encode(JSON.stringify(data)));};

// 课程详情
exports.shopOrder = shopOrder;var classOrder = function classOrder(data) {return _request.default.post('/api/index/courseDetails', _base.default.encode(JSON.stringify(data)));};

// 课程预约
exports.classOrder = classOrder;var courseOrder = function courseOrder(data) {return _request.default.post('/api/index/courseOrder', _base.default.encode(JSON.stringify(data)));};exports.courseOrder = courseOrder;

/***/ }),

/***/ 128:
/*!****************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/util.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _calendar = _interopRequireDefault(__webpack_require__(/*! ./calendar.js */ 129));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
...
/***/ 129:
/*!********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/calendar.js ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!*************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/static/request.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.common = void 0;function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
// 全局配置
var common = {
  ...
  data: { request: '' },
  method: 'GET',
  dataType: 'json' };exports.common = common;var _default =
...
/***/ 130:
/*!**********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/i18n/index.js ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 131:
/*!*********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/i18n/en.json ***!
  \*********************************************************************************************************/
...
/***/ 132:
/*!**************************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/i18n/zh-Hans.json ***!
  \**************************************************************************************************************/
...
/***/ 133:
/*!**************************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-calendar/components/uni-calendar/i18n/zh-Hant.json ***!
  \**************************************************************************************************************/
/*! exports provided: uni-calender.ok, uni-calender.cancel, uni-calender.today, uni-calender.SUN, uni-calender.MON, uni-calender.TUE, uni-calender.WED, uni-calender.THU, uni-calender.FRI, uni-calender.SAT, default */
/***/ (function(module) {
...
/***/ 14:
/*!**********************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/static/base.js ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ 145:
/*!**********************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/pages.json?{"type":"stat"} ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__D9FE264" };exports.default = _default;

/***/ }),

/***/ 146:
/*!****************************************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-file-picker/components/uni-file-picker/choose-and-upload-file.js ***!
  \****************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 141)["default"]))

/***/ }),

/***/ 147:
/*!***********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/uni_modules/uni-file-picker/components/uni-file-picker/utils.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.get_file_data = exports.get_file_info = exports.get_files_and_is_max = exports.get_extname = exports.get_file_ext = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 142));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         * 获取文件名和后缀
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         * @param {String} name
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         */
...
/***/ 5:
/*!******************************************************!*\
  !*** C:/Users/Administrator/Desktop/乐舍陶艺/pages.json ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
